...
public class Moveable extends Obj {
	...
	public Moveable(double ex, double why, int sizeX, int sizeY, double hbx, double hby, int hbwidth, int hblength) {
		super(ex, why, sizeX, sizeY, hbx, hby, hbwidth, hblength);	}
	public Moveable(double ex, double why, int sizeX, int sizeY, ImageView person, double hbx, double hby, int hbwidth,
			int hblength, Animator enemy, FrameSetter enemySetter) {
		super(ex, why, sizeX, sizeY, hbx, hby, person, hbwidth, hblength, enemy, enemySetter);
	}
